---
title: "Getting Started with hsreg"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with hsreg}
...
The **hsreg** package provides a Gibbs sampler for Bayesian linear
...
fit <- hsreg(y, X, n_mcmc = 500, burnin = 200, verbose = FALSE, seed = 42)
print(fit)
```
...
fit <- hsreg(y, X, penalized = penalized,
...
fit <- hsreg(y, X, saving = tmpfile, n_mcmc = 1000, burnin = 500)

# Later: extract CATEs from the saved file
cates <- hsreg_cates_from_file(tmpfile, X_test, n_x = 5, n_d = 2)
```
